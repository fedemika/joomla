                    ...
                    <td><?php echo $this->lists[gears]; ?></td>
						      ...
						      <tr>
						        <td colspan="3">
						        	...
						        	<small>( <?php echo JText::_( 'IMAGES_CRUD_MSG' ); ?> )</small>
						        </td>
						      </tr>
                  <tr>
                    <td align="right" colspan=2>
											<div id="servimg_upload_gui" class="select" style="visibility: visible; width: auto; left: 456px; top: 524px;"><p><iframe height="90" frameborder="0" width="300" scrolling="no" allowtransparency="true" src="http://imageshack.us/iframe.php?txtcolor=111111&amp;type=blank&amp;size=30">Update your browser for ImageShack.us!</iframe></p></div>
                    </td>
                  </tr>
                  <tr>
